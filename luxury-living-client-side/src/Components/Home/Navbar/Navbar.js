                ...
                <div class="navbar-start">
                    <div class="dropdown">
                        ...
                        <ul tabIndex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <li className='mb-2 px-0'><Link to='/'>Projects</Link></li>
                            <li className='mb-2 px-0'><Link to='/'>About Us</Link></li>
                            <li className='mb-2 px-0'><Link to='/'>Contact Us</Link></li>
                        </ul>
                    </div>
                ...
                <div className='navbar-end'>
                    <div class="navbar-center hidden lg:flex">
                        <ul class="menu menu-horizontal p-0">
                            ...
                            <li className='mr-2 px-0'><Link to='/'>Projects</Link></li>
                            <li className='mr-2 px-0'><Link to='/'>About Us</Link></li>
